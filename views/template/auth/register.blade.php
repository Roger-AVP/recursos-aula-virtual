...
<head>
    ...
    <title>{{ __('Virtual classroom') }} - {{ __('Register') }}</title>
                            ...
                            <form class="user" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    <input type="text"
                                        ...
                                        id="name" placeholder="First Name" name="name" value="{{ old('name') }}"
                                ...
                                <hr>
                                <a href="{{ route('social.auth', 'google') }}" class="btn btn-google btn-user btn-block">
